document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value.trim() !== '') {
        ...
        if (minLength && !VALIDATORS.minlength(value, minLength)) {
          const msg = typeof ERROR_MESSAGES.minlength === 'function'
    ...
    function getFormFields() {
      ...
      ).filter((field) => field.type !== 'submit' && field.type !== 'button' && field.type !== 'reset' && field.type !== 'hidden');
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דיגי עודד קדוש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0730477d-4f40-409c-acd5-3273e1c2329e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0730477d-4f40-409c-acd5-3273e1c2329e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0730477d-4f40-409c-acd5-3273e1c2329e';
